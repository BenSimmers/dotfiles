...
function registerProviders() {
    ...
    lw.registerDisposable(vscode.languages.registerDocumentFormattingEditProvider(latexindentSelector, latexformatter_1.LatexFormatterProvider.instance), vscode.languages.registerDocumentFormattingEditProvider({ scheme: 'file', language: 'bibtex' }, bibtexformatter_1.BibtexFormatterProvider.instance), vscode.languages.registerDocumentRangeFormattingEditProvider(latexindentSelector, latexformatter_1.LatexFormatterProvider.instance), vscode.languages.registerDocumentRangeFormattingEditProvider({ scheme: 'file', language: 'bibtex' }, bibtexformatter_1.BibtexFormatterProvider.instance));
